...
/* invalid request_max_redirect - non-numeric value */
CREATE SERVER rdfserver_error20
FOREIGN DATA WRAPPER rdf_fdw 
OPTIONS (    
  endpoint 'https://dbpedia.org/sparql',
...
/* invalid request_max_redirect - negative value */
CREATE SERVER rdfserver_error21
FOREIGN DATA WRAPPER rdf_fdw 
OPTIONS (    
  endpoint 'https://dbpedia.org/sparql',
...
/* invalid request_max_redirect - white space */
CREATE SERVER rdfserver_error22
FOREIGN DATA WRAPPER rdf_fdw 
OPTIONS (    
  endpoint 'https://dbpedia.org/sparql',
...
/* invalid request_max_redirect - float value */
CREATE SERVER rdfserver_error23
FOREIGN DATA WRAPPER rdf_fdw 
OPTIONS (    
  endpoint 'https://dbpedia.org/sparql',
  request_max_redirect '1.5'
);

/* valid request_max_redirect - 0 refuses any redirect */
CREATE SERVER rdfserver_maxredirect0
FOREIGN DATA WRAPPER rdf_fdw 
OPTIONS (    
  endpoint 'https://dbpedia.org/sparql',
  request_max_redirect '0'
);

/* valid request_max_redirect - follow at most 5 redirects */
CREATE SERVER rdfserver_maxredirect5
FOREIGN DATA WRAPPER rdf_fdw 
OPTIONS (    
  endpoint 'https://dbpedia.org/sparql',
  request_max_redirect '5'
);

/* deprecated request_redirect - still accepted, but warns */
CREATE SERVER rdfserver_deprecated_redirect
FOREIGN DATA WRAPPER rdf_fdw 
OPTIONS (    
  endpoint 'https://dbpedia.org/sparql',
...
DROP SERVER rdfserver_maxredirect0;
DROP SERVER rdfserver_maxredirect5;
DROP SERVER rdfserver_deprecated_redirect;
