...
SELECT '"foo"@en-us'::rdfnode = '"foo"@EN-US'::rdfnode; -- Should return true
SELECT '"foo"@en'::rdfnode = '"foo"@en-us'::rdfnode; -- Should return false
SELECT '"café"@fr'::rdfnode = '"café"@fr'::rdfnode; -- Should return true
SELECT '"café"@fr'::rdfnode = '"cafe"@fr'::rdfnode; -- Should return false
...
SELECT '"foo"^^<http://example.org/custom>'::rdfnode = '"foo"^^xsd:string'::rdfnode; -- Should return false
SELECT '"foo"^^<http://invalid>'::rdfnode = '"foo"^^<http://invalid>'::rdfnode; -- Should return true
...
SELECT '"-0"^^xsd:int'::rdfnode = '"0"^^xsd:int'::rdfnode; -- Should return true (numeric zero)
SELECT '"999999999999999999"^^xsd:integer'::rdfnode = '"999999999999999999.0"^^xsd:decimal'::rdfnode; -- Should return true
...
SELECT '"2011-10-08"^^xsd:date'::rdfnode = ''::rdfnode;
SELECT '"0001-01-01"^^xsd:date'::rdfnode = '"0001-01-01"^^xsd:date'::rdfnode; -- Should return true
SELECT '"2025-13-01T12:00:00"^^xsd:dateTime'::rdfnode = '"2025-13-01T12:00:00"^^xsd:dateTime'::rdfnode; -- Should return true (despite invalid month)
SELECT '"2025-04-25T25:00:00Z"^^xsd:dateTime'::rdfnode = '"2025-04-25T25:00:00Z"^^xsd:dateTime'::rdfnode; -- Should return true (despite invalid hour)
SELECT '"1.0E308"^^xsd:double'::rdfnode = '"1.0E308"^^xsd:double'::rdfnode; -- Should return true (despite being out of range for finite double)
SELECT '"invalid"^^xsd:dateTime'::rdfnode = '"invalid"^^xsd:dateTime'::rdfnode; -- Should return true (despite invalid format)
...
SELECT '"2025-04-25T18:44:38.149101Z"^^xsd:dateTime'::rdfnode = ''::rdfnode;
SELECT '"2025-04-25T18:44:38"^^xsd:dateTime'::rdfnode = '"2025-04-25T18:44:38Z"^^xsd:dateTime'::rdfnode; -- Should return false (missing timezone as UTC)
SELECT '"2025-04-25T18:44:38+01:00"^^xsd:dateTime'::rdfnode = '"2025-04-25T17:44:38Z"^^xsd:dateTime'::rdfnode; -- Should return true (same UTC moment)
SELECT '"2025-04-25T18:44:38-04:00"^^xsd:dateTime'::rdfnode = '"2025-04-25T22:44:38Z"^^xsd:dateTime'::rdfnode; -- Should return true
SELECT '"2025-04-25T18:44:38"^^xsd:dateTime'::rdfnode = '"2025-04-25T18:44:38+01:00"^^xsd:dateTime'::rdfnode; -- Should return false (UTC vs. +01:00)
SELECT '"0001-01-01T00:00:00Z"^^xsd:dateTime'::rdfnode = '"0001-01-01T00:00:00Z"^^xsd:dateTime'::rdfnode; -- Should return true
SELECT '"9999-12-31T23:59:59Z"^^xsd:dateTime'::rdfnode = '"9999-12-31T23:59:59Z"^^xsd:dateTime'::rdfnode; -- Should return true
