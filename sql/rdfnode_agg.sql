...
-- Test 27: SUM on non-numeric rdfnode → should error
WITH j (val) AS (
    VALUES
...
-- Test 28: AVG on non-numeric rdfnode → should error
WITH j (val) AS (
    VALUES
...
-- Test 29: SUM with mixed numeric and non-numeric → should error
WITH j (val) AS (
    VALUES
        ('"10"^^<http://www.w3.org/2001/XMLSchema#integer>'::rdfnode),
