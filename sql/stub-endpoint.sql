 ...
 *
 * client_min_messages is raised because rdf_fdw_clone_table() still reports
 * rdfnode columns as using a deprecated native PostgreSQL type; that is a
 * separate defect and not what this test is about.
 */
