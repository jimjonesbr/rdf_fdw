...
FROM sparql.describe('qlever', 'DESCRIBE <https://www.uni-muenster.de>')
ORDER BY object::text COLLATE "C";

/* graph pattern description */
SELECT subject, predicate, object
FROM sparql.describe('qlever','
...
SELECT * FROM sparql.describe('qlever', 'invalid');
SELECT * FROM sparql.describe('qlever', '   ');
SELECT * FROM sparql.describe('qlever', 'DESCRIBE https://www.uni-muenster.de'); -- missing < >

/* DESCRIBE pattern with a blank node */
SELECT * FROM sparql.describe('qlever', '_:bnode1');
SELECT * FROM sparql.describe('qlever', 'DESCRIBE _:bnode1');

/* malformed entity IRI */
SELECT * FROM sparql.describe('qlever', 'DESCRIBE <htt://i.am.malformed>');

/* SELECT query */
SELECT * FROM sparql.describe('qlever', 'SELECT ?s ?p ?o WHERE {?s ?p ?o}');
