...
WHERE
  p = '<http://schema.org/version>' AND
  sparql.datatype(o) = sparql.datatype('"2365081748"^^<http://www.w3.org/2001/XMLSchema#integer>');
...
WHERE 
  ...
  '"2365081748"^^xsd:string'::rdfnode = sparql.strdt(sparql.str(o),'xsd:string') AND
  sparql.strdt(sparql.str(o),'xsd:string') = '"2365081748"^^xsd:string'::rdfnode  AND
  sparql.strdt(sparql.str('"2365081748"^^xsd:integer'),'xsd:string') = sparql.strdt(sparql.str(o),'xsd:string') AND
  sparql.strdt(sparql.str(o),'xsd:string') = sparql.strdt(sparql.str('"2365081748"^^xsd:integer'),'xsd:string');
