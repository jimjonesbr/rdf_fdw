...
WHERE
  ...
  sparql.datatype(o) = sparql.datatype('"2462849572"^^<http://www.w3.org/2001/XMLSchema#integer>');
...
WHERE 
  ...
  '"2462849572"^^xsd:string'::rdfnode = sparql.strdt(sparql.str(o),'xsd:string') AND
  sparql.strdt(sparql.str(o),'xsd:string') = '"2462849572"^^xsd:string'::rdfnode  AND
  sparql.strdt(sparql.str('"2462849572"^^xsd:integer'),'xsd:string') = sparql.strdt(sparql.str(o),'xsd:string') AND
  sparql.strdt(sparql.str(o),'xsd:string') = sparql.strdt(sparql.str('"2462849572"^^xsd:integer'),'xsd:string');
