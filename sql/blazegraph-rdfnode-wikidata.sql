...
WHERE 
  ...
  o = 2346087135::bigint AND
  o <> 9999999999::bigint AND
  o >= 2346087135::bigint AND
  o <= 2346087135::bigint AND
  o BETWEEN 2346087000::bigint AND 2346087999::bigint AND
  2346087135::bigint = o AND
...
WHERE
  p = '<http://schema.org/version>' AND
  sparql.datatype(o) = sparql.datatype('"2346087135"^^<http://www.w3.org/2001/XMLSchema#integer>');
...
WHERE 
  ...
  '"2346087135"^^xsd:string'::rdfnode = sparql.strdt(sparql.str(o),'xsd:string') AND
  sparql.strdt(sparql.str(o),'xsd:string') = '"2346087135"^^xsd:string'::rdfnode  AND
  sparql.strdt(sparql.str('"2346087135"^^xsd:integer'),'xsd:string') = sparql.strdt(sparql.str(o),'xsd:string') AND
  sparql.strdt(sparql.str(o),'xsd:string') = sparql.strdt(sparql.str('"2346087135"^^xsd:integer'),'xsd:string');
...
WHERE 
  p = '<http://schema.org/version>'::rdfnode AND
  sparql.abs(o) = 2346087135::bigint AND
  sparql.abs(o) <> 9999999999::bigint AND
  sparql.abs(o) >= 2346087135::bigint AND
  sparql.abs(o) <= 2346087135::bigint AND
  sparql.abs(o) BETWEEN 2346087000::bigint AND 2346087999::bigint AND
  sparql.abs(o) =  '"2346087135"^^xsd:long'::rdfnode AND
  sparql.abs(o) >  '"1111111111"^^xsd:long'::rdfnode AND
  sparql.abs(o) >= '"2346087135"^^xsd:long'::rdfnode AND
  sparql.abs(o) <  '"9999999999"^^xsd:long'::rdfnode AND
  sparql.abs(o) <= '"2346087135"^^xsd:long'::rdfnode AND
  2346087135::bigint = sparql.abs(o) AND
  '"2346087135"^^xsd:long'::rdfnode = sparql.abs(o);
