...
WHERE
  ...
  sparql.datatype(o) = sparql.datatype('"2456654040"^^<http://www.w3.org/2001/XMLSchema#integer>');
...
WHERE 
  ...
  '"2456654040"^^xsd:string'::rdfnode = sparql.strdt(sparql.str(o),'xsd:string') AND
  sparql.strdt(sparql.str(o),'xsd:string') = '"2456654040"^^xsd:string'::rdfnode  AND
  sparql.strdt(sparql.str('"2456654040"^^xsd:integer'),'xsd:string') = sparql.strdt(sparql.str(o),'xsd:string') AND
  sparql.strdt(sparql.str(o),'xsd:string') = sparql.strdt(sparql.str('"2456654040"^^xsd:integer'),'xsd:string');
