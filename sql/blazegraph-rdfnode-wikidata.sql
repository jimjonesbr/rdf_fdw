...
WHERE
  ...
  sparql.datatype(o) = sparql.datatype('"2473333318"^^<http://www.w3.org/2001/XMLSchema#integer>');
...
WHERE 
  ...
  '"2473333318"^^xsd:string'::rdfnode = sparql.strdt(sparql.str(o),'xsd:string') AND
  sparql.strdt(sparql.str(o),'xsd:string') = '"2473333318"^^xsd:string'::rdfnode  AND
  sparql.strdt(sparql.str('"2473333318"^^xsd:integer'),'xsd:string') = sparql.strdt(sparql.str(o),'xsd:string') AND
  sparql.strdt(sparql.str(o),'xsd:string') = sparql.strdt(sparql.str('"2473333318"^^xsd:integer'),'xsd:string');
